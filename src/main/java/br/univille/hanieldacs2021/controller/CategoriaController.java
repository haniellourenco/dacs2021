...
/***
 * CategoriaController representa a camada controller da aplicação que deve ser
 * responsável por receber as requisições HTTP, aplicar o mecanismo de rotas do
 * SpringBoot, executar a lógica dos métodos mapeados chamando as classes de
 * serviço para realizar as ações necessárias e então repassar o resultado dos
 * dados dentro de instâncias das classes model para a view que será retornada
