...
import br.univille.hanieldacs2021.model.ItemVenda;
...
import br.univille.hanieldacs2021.service.VendaService;
...
public class VendaController {
    ...
    public ModelAndView save(Venda venda) {
        ...
        venda.setValorTotal(venda.getColItemVenda().stream().reduce(0f,
                (acumulador, item) -> acumulador + item.getValor(), Float::sum));
        service.save(venda);
